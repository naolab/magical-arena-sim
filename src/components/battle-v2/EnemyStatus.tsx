  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl bg-gradient-to-br from-red-500/20 to-red-700/20 p-4 backdrop-blur-sm border border-red-400/30">
      ...
      <div className="flex flex-col gap-1">
        ...
        <div
          className="h-3 w-full overflow-hidden rounded-full bg-black/40 cursor-pointer hover:ring-2 hover:ring-red-400/50 transition-all"
          onClick={() => setShowHpDetails(!showHpDetails)}
          title="クリックでHP詳細を表示"
        >
          <div
            className="h-full rounded-full bg-gradient-to-r from-red-500 to-red-400 transition-all duration-300 pointer-events-none"
