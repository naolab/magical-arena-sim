...
export function CommandBubbles({ bubbles, phase, visibleCount }: CommandBubblesProps) {
  return (
    <div className="pointer-events-none absolute inset-0">
      {bubbles.map((bubble, index) => {
        const isActivePhase = phase === 'announcing' || phase === 'selecting';
        const isVisible = isActivePhase && index < visibleCount;
